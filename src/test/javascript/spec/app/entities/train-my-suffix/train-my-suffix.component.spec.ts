...
import { TrainMySuffixComponent } from 'app/entities/train-my-suffix/train-my-suffix.component';
...
describe('Component Tests', () => {
    describe('TrainMySuffix Management Component', () => {
        let comp: TrainMySuffixComponent;
        let fixture: ComponentFixture<TrainMySuffixComponent>;
        let service: TrainMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [RailwaysTestModule],
                declarations: [TrainMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(TrainMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(TrainMySuffixComponent);
